...
function RecordRow(props) {
  return (
    <div className='recordRow'>
      ...
      <div className='records_item_from'>From:{(props.info.record.get_time).split("T")[0]+"("+(props.info.record.get_time).split("T")[1]+")"}</div>
      <div className='records_item_to'>To:{props.info.record.return_time?((props.info.record.return_time).split("T")[0]+"("+(props.info.record.return_time).split("T")[1]+")"):""}</div>
